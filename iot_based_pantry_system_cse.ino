...
String msg = "\0";
String r = "http://projectsiot.xyz/IoTProjects/PantrySystem/upload.php?a=";
String rs = "\0";
int v = 0;
...
void setup()
{
  ...
  lcdstring(0,1," PANTRY  SYSTEM  ");
  delay(2000);

pinMode(buzzer,OUTPUT);
pinMode(sw1,INPUT);
pinMode(sw2,INPUT);pinMode(sw4,INPUT);
...
state='C';
  lcdstring(0,0,"PANTRY SYSTEM  ");
  lcdstring(0,1,"ITEAM 3 SELECTED");
  beep ();
...
state='A';
  lcdstring(0,1,"ITEAM 1 SELECTED");
beep ();
 delay(1000);
...
state='B';
  lcdstring(0,1,"ITEAM 2 SELECTED");
beep ();
...
state='D';
  lcdstring(0,1,"ITEAM 4 SELECTED");
beep ();
