...
String msg = "\0";
String r = "http://projectsiot.xyz/IoTProjects/CableFault/fault.php?a=";
String rs = "\0";
int v = 0;
...
void setup()
{
  ...
  lcd.begin(16, 2);
  lcd.clear();
  lcdstring(0,0,"UNDERGROUND CABLE");
  lcdstring(0,1,"  FAULT SYSTEM   ");
  delay(2000);
...
if(WiFi.status()== WL_CONNECTED){ //Check WiFi connection status
  ...
  http.begin("http://projectsiot.xyz/IoTProjects/CableFault/fault.php?a=U&b=0");
...
{
  lcdstring(0,1,"FAULT AT:"+String(vol));
  state='N';
