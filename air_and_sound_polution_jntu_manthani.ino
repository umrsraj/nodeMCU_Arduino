...
String msg = "\0";
String r = "http://projectsiot.xyz/IoTProjects/AirSoundPollution1/upload.php?a=";
String rs = "\0";
int v = 0;
...
if(WiFi.status()== WL_CONNECTED){ //Check WiFi connection status
  ...
  http.begin("http://projectsiot.xyz/IoTProjects/AirSoundPollution1/upload.php?a=U&b=0");
...
{
  lcdstring(0,1,"Air : Normal    ");
  G = "N";
  vol = analogRead(voltage_sensor);
  delay(50);
}

if ((digitalRead(gas)==LOW)&&(vol < 550))
{
  delay(100);
