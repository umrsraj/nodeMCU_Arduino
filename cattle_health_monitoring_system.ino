...
String msg = "\0";
String r = "http://projectsiot.xyz/IoTProjects/CattleHealth/healthupload.php?a=";
String rs = "\0";
#define buzzer D8
#define temp A0
#define heart D6
...
if(WiFi.status()== WL_CONNECTED){ //Check WiFi connection status
  ...
  http.begin("http://projectsiot.xyz/IoTProjects/CattleHealth/healthupload.php?a=U");
